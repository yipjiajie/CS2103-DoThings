...
public class TestLogic {
	...
	public void testCustomCommandHandler() {
		...
		Feedback feedback = CustomCommandHandler.addCustomCommand("insert",
		        "[ADD]");
		assertEquals(feedback.toString(),
		        CustomCommandHandler.MESSAGE_CUSTOM_DUPLICATE);
	...
	public void testTaskTimeMethods() {
		Task task1 = new Task("This is a dummy scheduled task",
		        new DateTime().minusDays(2), null, "yolo");
		assertTrue(task1.isOverdue());
		assertFalse(task1.isUnscheduled());
		
		Task task2 = new Task("This is a second dummy scheduled task",
		        new DateTime(), new DateTime(), "yolo");
	...
	public void testTaskOtherMethods() {
		// test toString()
		Task task = new Task("This is to test the string methods", null, null,
		        "trippy");
		...
		assertEquals("This is to test the string methods",
		        task.getDescription());
		...
		// test compareTo()
		Task task1 = new Task("This is the a scheduled task", new DateTime(),
		        new DateTime(), "yoko");
		Task task2 = new Task("This is the a scheduled task", new DateTime(),
		        new DateTime(), "hama");
		Task task3 = new Task("This is the another scheduled task",
		        new DateTime().plusHours(1), null, "coco");
