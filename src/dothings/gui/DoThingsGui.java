...
public class DoThingsGui extends JFrame {
	...
	/**
	 * creates task panel scroll which sits below the input field (i.e. white box). Gives scroll
	...
	public static class ResponsiveContent {
		...
		/**
		 * function to create task object panel which holds task description, alias and date & time
		 * text areas
		 * 
		...
		private static void createTaskDescription(int descriptionExtension,
			...
			taskDescription.get(i).setBounds(TASK_DESCRIPTION_X_OFFSET,
			        ...
			        TASK_DESCRIPTION_HEIGHT + descriptionExtension); // 55 characters
		...
		/**
		 * Creates task object which is one panel holding all the description, alias and date & time
		 * text fields
		 * 
		 * @param aliasExtension
		 * @param descriptionExtension
		...
		/**
		 * determines additional height that needs to be added to the task object to fit text
		 * overflow in alias field
		 * 
		 * @param i
		...
		/**
		 * determines additional height that needs to be added to the task object panel to fit text
		 * overflow in description field
		 * 
		 * @param i
		 * @return additionalHeight
		 */
		...
		/**
		 * sets color schemes for message panel, task description font, alias font and date time
		 * font
		 * 
		 * @param i
